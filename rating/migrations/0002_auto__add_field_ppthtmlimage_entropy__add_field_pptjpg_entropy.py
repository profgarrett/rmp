...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PptHtmlImage.entropy'
        db.add_column('rating_ppthtmlimage', 'entropy',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=9, decimal_places=5, blank=True),
                      keep_default=False)

        # Adding field 'PptJpg.entropy'
        db.add_column('rating_pptjpg', 'entropy',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=9, decimal_places=5, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PptHtmlImage.entropy'
        db.delete_column('rating_ppthtmlimage', 'entropy')

        # Deleting field 'PptJpg.entropy'
        db.delete_column('rating_pptjpg', 'entropy')
